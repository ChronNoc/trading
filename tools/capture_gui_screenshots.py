...
RESOLUTIONS = (("1366x768", 1366, 768, 1.0), ("1920x1080", 1920, 1080, 1.0),
               ("highdpi_2x_1366x768", 1366, 768, 2.0))
...
def main() -> int:
    ...
    from tests.test_app_window import _rich_snapshot
    ...
    for label, width, height, scale in RESOLUTIONS:
        window = AppWindow(snapshot_provider=_rich_snapshot, start_timer=False, gui_scale=scale)
